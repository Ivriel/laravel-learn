...
class RoutingTest extends TestCase
{
   ...
   {
    $this->get('/pzn')->assertStatus(200)->assertSeeText('Hello Ivriel');
   }
   ...
   {
    $this->get('/tidakada')->assertSeeText('404 by Ivriel');
   }
   ...
   public function testRouteParameterRegex()
   {
      ...
      $this->get('/categories/ivriel')->assertSeeText('404 by ivriel');
   }

   public function testRouteParameterOptional()
   {
      $this->get('/users/ivriel')->assertSeeText('User ivriel');
      $this->get('/users/')->assertSeeText('User 404');
   }

   public function testRouteConflict()
   {
      $this->get('/conflict/ivriel')->assertSeeText("Conflict ivriel");
      $this->get('/conflict/gunawan')->assertSeeText("Conflict gunawan");
   }
